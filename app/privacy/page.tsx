    ...
    <main className="min-h-screen bg-gray-50 px-4 py-16 font-sans">
      <section className="mx-auto max-w-2xl bg-white border border-gray-200 p-8 rounded-none shadow-sm">
        ...
        <p className="text-gray-600 mb-6">
          Handijob is a demo MVP. User reports, artisan applications, chat messages, and escrow records are stored in the demo data layer for judging and product testing.
        </p>
