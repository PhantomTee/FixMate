    ...
    <>
      <style>{`
        @keyframes wa-glow {
          ...
          50%       { box-shadow: 0 4px 22px rgba(37,211,102,.55); }
        }
        .wa-fab {
          animation: wa-glow 4s ease-in-out infinite;
        }
        .wa-fab:hover {
          animation: none;
      ...
      <Link
        ...
        className="wa-fab fixed bottom-20 right-4 md:bottom-6 md:right-6 z-50
