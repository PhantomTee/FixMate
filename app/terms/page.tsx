    ...
    <main className="min-h-screen bg-gray-50 px-4 py-16 font-sans">
      <section className="mx-auto max-w-2xl bg-white border border-gray-200 p-8 rounded-none shadow-sm">
        ...
        <p className="text-gray-600 mb-6">
          This MVP is for demonstration only. Artisan matching, wallet balances, and OPay escrow actions are simulated unless production credentials and verification are added later.
        </p>
